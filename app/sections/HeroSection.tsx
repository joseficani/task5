...
export default function HeroSection() {
  ...
  return (
    ...
    >
      <div
        ref={navBgRef}
        className="pointer-events-none absolute left-0 top-0 z-20 h-28 w-full bg-gradient-to-b from-black/40 to-transparent"
      />

      <div className="container mx-auto h-full px-6 md:px-12">
        <div className="absolute left-0 top-0 z-30 flex w-full items-start justify-between px-6 pt-7 md:px-12">
