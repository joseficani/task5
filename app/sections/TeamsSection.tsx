...
export default function TeamsSection() {
  ...
  const citiesTrackRef = useRef<HTMLDivElement | null>(null);

  useEffect(() => {
    if (!sectionRef.current || !citiesTrackRef.current) return;

    const ctx = gsap.context(() => {
      gsap.to(citiesTrackRef.current, {
        xPercent: -38,
        ease: "none",
        scrollTrigger: {
  ...
  return (
    ...
    >
      <div className="container mx-auto flex min-h-screen w-full flex-col justify-center px-6 md:px-12">
